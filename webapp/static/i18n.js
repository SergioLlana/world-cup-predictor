...
odds ──→ margin-free 1X2 ─────────────────────────────┤  (rescales the 1X2)
      ...
      <details class="card doc-card doc-appendix">
        ...
        <div class="doc-body">
          ...
          <p>Why does the web default to <b>Elo</b> rather than the production dc? Because with the market odds on it hardly matters: the 1X2 comes from the market and the engine only shapes the scorelines, so the differences between engines are small — and the CLI and the production snapshots stay on dc.</p>
        </div>
      </details>`,
  },
...
cuotas ──→ 1X2 sin margen ──────────────────────────────┤  (reescala el 1X2)
      ...
      <details class="card doc-card doc-appendix">
        ...
        <div class="doc-body">
          ...
          <p>¿Por qué la web usa <b>Elo</b> por defecto y no el dc de producción? Porque con las cuotas de mercado activadas apenas importa: el 1X2 sale del mercado y el motor solo da forma a los marcadores, así que las diferencias entre motores son pequeñas — y la CLI y los snapshots de producción siguen en dc.</p>
        </div>
      </details>`,
  },
};
